...
extern "C" __declspec(dllexport) int SetControllerMuting(Controller controller, bool state);

extern "C" __declspec(dllexport) int GetControllerMuting(Controller controller, bool &state);

extern "C" __declspec(dllexport) int GetJoystickValue(JoystickCommand &joystickCommand);

extern "C" __declspec(dllexport) int GetJoystickValueSpecific(Controller controllerType, JoystickCommand &joystickCommand);
